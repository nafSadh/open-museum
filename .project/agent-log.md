...
| 57 | 2026-05-19 | asg-rrv-image-backfill-retry | Run asg_rrv_backfill.py to resolve the remaining missing images for Amrita Sher-Gil and Raja Ravi Varma, then rebuild the search index | done | Manually resolved 4 Amrita Sher-Gil and 1 Raja Ravi Varma images via Commons API, removed 12 duplicate entries from Raja Ravi Varma catalog, and rebuilt search index. |
| 58 | 2026-05-20 | goya-build | Build Francisco Goya collection: scrape, resolve, enrich, build gallery UI | done | 844 works (504 paintings, 340 prints); 844/844 resolved; gallery page, root link & search index updated |
