#!/usr/bin/env python3
"""
Resolve Wikimedia Commons image URLs for rembrandt/wiki_works_raw.json.
Outputs: rembrandt/catalog.json
"""
...
INPUT_PATH = "rembrandt/wiki_works_raw.json"
OUTPUT_PATH = "rembrandt/catalog.json"
