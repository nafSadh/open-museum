#!/usr/bin/env python3
"""
Resolve Wikimedia Commons image URLs for vermeer/wiki_works_raw.json.
Outputs: vermeer/catalog.json
"""
...
INPUT_PATH = "vermeer/wiki_works_raw.json"
OUTPUT_PATH = "vermeer/catalog.json"
